...
def ResNet50(input_shape = (64, 64, 3), classes = 6):
    ...
    # Stage 1
    X = Conv1D(filters=64, kernel_size=(7), strides=(2), name="conv",
    ...
    X = convolutional_block(X, f=3, filters=[32,32,64], stage=5, block="a", s=2)
    X = identity_block(X, f=3, filters=[32,32,64], stage=5, block="b")
